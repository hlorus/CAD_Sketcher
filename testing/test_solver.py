...
class TestSolver2d(Sketch2dTestCase):
    def test_example_2d(self):
        ...
        # Add constraints
        ssc.add_distance(sketch=sketch, curve_id_1=p1.curve_id, curve_id_2=p2.curve_id).value = 30
        ssc.add_distance(sketch=sketch, curve_id_1=origin.curve_id, curve_id_2=line.curve_id).value = 10
        ssc.add_vertical(sketch=sketch, curve_id_1=line.curve_id)
        ssc.add_distance(sketch=sketch, curve_id_1=origin.curve_id, curve_id_2=p1.curve_id).value = 15
        ssc.add_equal(sketch=sketch, curve_id_1=arc.curve_id, curve_id_2=circle.curve_id)
        ssc.add_diameter(sketch=sketch, curve_id_1=arc.curve_id).value = 17.0/2
    ...
    def test_example_2d_fail(self):
        ...
        ssc.add_vertical(sketch=sketch, curve_id_1=line.curve_id)
        ssc.add_distance(sketch=sketch, curve_id_1=origin.curve_id, curve_id_2=p1.curve_id).value = 15
        ssc.add_distance(sketch=sketch, curve_id_1=origin.curve_id, curve_id_2=p2.curve_id).value = 18
        ssc.add_equal(sketch=sketch, curve_id_1=arc.curve_id, curve_id_2=circle.curve_id)
        ssc.add_diameter(sketch=sketch, curve_id_1=arc.curve_id).value = 17.0/2
