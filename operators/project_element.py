...
class VIEW3D_OT_slvs_project_element(Operator, GenericEntityOp):
    """Project a picked mesh vertex, edge or face into the active sketch"""

    bl_idname = Operators.ProjectElement
...
register, unregister = register_stateops_factory((VIEW3D_OT_slvs_project_element,))
