...
class Operators(str, Enum):
    ...
    AddLinkedSketch = "view3d.slvs_add_linked_sketch"
    ...
    AddSketchOriginOffset = "view3d.slvs_add_sketch_origin_offset"
    ...
    ContextMenuSketch = "view3d.slvs_sketch_tag_context_menu"
    ...
    EditTagParameters = "view3d.slvs_edit_tag_parameters"
    ...
    RemoveGroupCoincidentConstraints = "view3d.slvs_remove_group_coincident_constraints"
    RemoveEntityReferenceGeometry = "view3d.slvs_remove_entity_reference_geometry"
    RemoveMemberReferenceGeometry = "view3d.slvs_remove_member_reference_geometry"
