...
class VIEW3D_T_slvs_node_array_circular(GenericStateTool, WorkSpaceTool):
    bl_space_type = "VIEW_3D"
    bl_context_mode = "OBJECT"
    bl_idname = WorkSpaceTools.ArrayCircular
    bl_label = "Circular Array"
    bl_operator = Operators.NodeArrayCircular
    bl_icon = "ops.transform.rotate"
    bl_widget = GizmoGroups.ObjectHover
    bl_keymap = (
        *tool_node,
        *operator_access(Operators.NodeArrayCircular),
    )
